# Autogenerated wrapper script for z3_jll for x86_64-apple-darwin14-cxx03
export z3, libz3jl, libz3
...
# Relative path to `libz3jl`
const libz3jl_splitpath = ["lib", "libz3jl.dylib"]

# This will be filled out by __init__() for all products, as it must be done at runtime
libz3jl_path = ""

# libz3jl-specific global declaration
# This will be filled out by __init__()
libz3jl_handle = C_NULL

# This must be `const` so that we can use it with `ccall()`
const libz3jl = "@rpath/libz3jl.dylib"
...
function __init__()
    ...
    global libz3jl_path = normpath(joinpath(artifact_dir, libz3jl_splitpath...))

    # Manually `dlopen()` this right now so that future invocations
    # of `ccall` with its `SONAME` will find this path immediately.
    global libz3jl_handle = dlopen(libz3jl_path)
    push!(LIBPATH_list, dirname(libz3jl_path))
