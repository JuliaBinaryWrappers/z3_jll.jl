...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import z3_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("1bc4e1ec-7839-5212-8f2f-0d16b7bd09bc"))
platforms = [Pkg.Artifacts.unpack_platform(e, "z3", artifacts_toml) for e in artifacts["z3"]]
...
if best_platform === nothing
    @debug("Unable to load z3; unsupported platform $(triplet(platform_key_abi()))")
else
